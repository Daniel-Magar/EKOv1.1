...
const OurSolution = () => {
  return (
    <section
      className="py-[2rem] lg:py-4 xl:py-[6rem] 2xl:py-[4rem]"
      id="industries"
    >
        ...
        <div className=" flex justify-between  text-white mx-[1rem] md:mx-[3rem] md:mt-[0rem] lg:mt-[0rem] xl:mt-[-10rem] mr-6 md:mr-[2rem] lg:mr-[4rem] xl:mr-[4.5rem]">
          ...
          <div className="z-[1] ">
            <div className="w-full">
              <h1 className="text-right md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-7xl font-normal tracking-widest z-[1]">
                MULTIPLE INDUSTRIES
              </h1>
            </div>
          </div>
