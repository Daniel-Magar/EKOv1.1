  ...
  return (
    <section>
      <div className="  h-auto">
        <div className="bg-black w-full  min-h-[14rem] md:min-h-[14rem] lg:min-h-[14rem] xl:min-h-[22rem] 2xl:min-h-[27rem] py-10 lg:py-2 xl:py-10 2xl:py-14 z-10  flex flex-col  md:flex-col lg:flex-row-reverse">
